  ...
  return (
    <View style={{ backgroundColor:'#fff', borderRadius:14, borderWidth:1, borderColor:'#f1f5f9',
      ...
      <View style={{flexDirection:'row',gap:8,flexWrap:'wrap'}}>
        <TouchableOpacity onPress={() => onParticipantes(e)} style={{flex:1,minWidth:105,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:6,borderWidth:1,borderColor:'#bfdbfe',borderRadius:10,paddingVertical:9}}><Users size={14} color="#2563eb"/><Text style={{fontSize:12,fontWeight:'700',color:'#2563eb'}}>Participantes</Text></TouchableOpacity>
        {puedeMensaje && <TouchableOpacity
          onPress={() => onMensaje(e)}
          style={{ flex:1, minWidth:105, flexDirection:'row', alignItems:'center', justifyContent:'center', gap:6,
...
export default function TecnicoBuscadorScreen() {
  ...
  return (
    <View style={{ flex:1, backgroundColor:'#f8fafc' }}>
      ...
      <ScrollView keyboardShouldPersistTaps="handled" automaticallyAdjustKeyboardInsets style={{ flex:1 }} contentContainerStyle={{ padding:16 }} showsVerticalScrollIndicator={false}>
        {loading && (
