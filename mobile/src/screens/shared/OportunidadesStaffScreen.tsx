...
export default function OportunidadesStaffScreen({ mostrarEncabezado = true }: { mostrarEncabezado?: boolean } = {}) {
  ...
  return <View style={{ flex: 1, backgroundColor: '#f8fafc' }}>
    {mostrarEncabezado && (
      <View style={{ backgroundColor: '#fff', paddingHorizontal: 16, paddingTop: insets.top + 16, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: '#f1f5f9' }}>
        <Text style={{ fontSize: 22, fontWeight: '800', color: '#0f172a' }}>Oportunidades</Text>
