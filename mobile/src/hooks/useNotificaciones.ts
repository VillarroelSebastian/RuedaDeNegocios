...
const EVENTO_LABELS: Record<string, string> = {
  ...
  'solicitud:mesa-no-disponible': 'Debes cambiar la mesa',
  'reunion:agendada':         'Reunión agendada',
  'reunion:cancelada':        'Reunión cancelada',
  'reunion:iniciada':         'Reunión iniciada',
  'reunion:inicio-solicitado':'Quieren iniciar la reunión',
  'reunion:enlace-actualizado':'Enlace virtual disponible',
